...
namespace TinyGiantStudio.Text
{
    ...
    public class ButtonEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            var xrToolkitSetupClass = Type.GetType("TinyGiantStudio.Text.XRToolkitEditorSetup");
            if (xrToolkitSetupClass != null)
                xrToolkitSetupClass.GetMethod("CreateSetupButton").Invoke(null, new object[] { myTarget.gameObject } );
            else
                EditorGUILayout.LabelField("xrToolkitEditorSetup class doesnt exist");
