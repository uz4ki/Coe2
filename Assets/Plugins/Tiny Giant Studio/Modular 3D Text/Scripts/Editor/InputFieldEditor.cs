...
namespace TinyGiantStudio.Text
{
    ...
    public class InputFieldEditor : Editor
    {
        ...
        void TextMats()
        {
            ...
            MText_Editor_Methods.PriviewField(outOfFocusTextMat, myTarget.outOfFocusTextMat, "Out of Focus Text", variableName + "outOfFocusTextMat");
            GUILayout.EndHorizontal();
        ...
        void BackgroundMats()
        {
            ...
            MText_Editor_Methods.PriviewField(outOfFocusBackgroundMat, myTarget.outOfFocusBackgroundMat, "Out of Focus", variableName + "outOfFocusBackgroundMat");
            GUILayout.EndHorizontal();
